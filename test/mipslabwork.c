...
void labwork( void )
{
  ...
  if(timeoutcount == 10) {
    ...
    tick( &mytime );
    display_string( 3, "text, more text, and even more text!text, more text, and even more text!" );
    display_string( 5, "text, more text, and even more text!text, more text, and even more text!" );
    display_update();
    *portE += 1;
    timeoutcount = 0; 
  }
