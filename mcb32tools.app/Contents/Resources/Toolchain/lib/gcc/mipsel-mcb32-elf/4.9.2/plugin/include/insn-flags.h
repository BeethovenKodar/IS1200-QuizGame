...
#define HAVE_muldi3 ((ISA_HAS_DMULT) && (TARGET_64BIT))
...
#define HAVE_smuldi3_highpart (ISA_HAS_DMULT && !(SIGN_EXTEND == ZERO_EXTEND && TARGET_FIX_VR4120))
#define HAVE_umuldi3_highpart (ISA_HAS_DMULT && !(ZERO_EXTEND == ZERO_EXTEND && TARGET_FIX_VR4120))
